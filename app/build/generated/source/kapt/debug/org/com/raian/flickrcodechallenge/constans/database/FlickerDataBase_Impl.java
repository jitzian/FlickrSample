...
import org.com.raian.flickrcodechallenge.constans.dao.FlickerDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoFlicker.equals(_existingFlicker)) {
          throw new IllegalStateException("Migration didn't properly handle flicker(org.com.raian.flickrcodechallenge.constans.model.FlickerDataClass).\n"
                  + " Expected:\n" + _infoFlicker + "\n"
                  + " Found:\n" + _existingFlicker);
        }
      }
